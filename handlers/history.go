...
func createHistoryHandler(c *gin.Context) error {
isError = false
...
setFlashmessages(c, "success", "History created successfully!!")
	...
	return renderView(c, history.HistoryIndex(
		"| Create History",
...
func historyListHandler(c *gin.Context) error {
	isError = false
...
func updateHistoryHandler(c *gin.Context) error {
	isError = false
